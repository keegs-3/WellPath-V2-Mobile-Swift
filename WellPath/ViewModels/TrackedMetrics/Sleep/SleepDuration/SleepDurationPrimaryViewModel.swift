...
class SleepDurationPrimaryViewModel: ObservableObject {
    ...
    init(metricId: String = "DISP_SLEEP_DURATION") {
    ...
    func loadPrimaryScreen() async {
        ...
        do {
            print("📊 Loading Sleep Duration primary screen for metric: \(metricId)")
            ...
            metrics = [SleepDurationPrimaryMetric(id: metric.metricId, metric: metric)]

            print("✅ Loaded Sleep Duration primary metric:")
