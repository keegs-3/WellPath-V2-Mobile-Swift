//
//  MoveMinutesPrimaryViewModel.swift
//  WellPath
//
//  Wrapper around StandardMetricViewModel for Move Minutes metric
//  Uses generic pattern with DISP_MOVE_MINUTES metric_id
//

import Foundation

@MainActor
class MoveMinutesPrimaryViewModel: ObservableObject {
    ...
    init() {
        self.standardViewModel = StandardMetricViewModel(metricId: "DISP_MOVE_MINUTES")
