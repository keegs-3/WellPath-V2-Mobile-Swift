//
//  ActiveCaloriesPrimaryViewModel.swift
//  WellPath
//
//  Wrapper around StandardMetricViewModel for Active Calories metric
//  Uses generic pattern with DISP_ACTIVE_CALORIES metric_id
//

import Foundation

@MainActor
class ActiveCaloriesPrimaryViewModel: ObservableObject {
    ...
    init() {
        self.standardViewModel = StandardMetricViewModel(metricId: "DISP_ACTIVE_CALORIES")
