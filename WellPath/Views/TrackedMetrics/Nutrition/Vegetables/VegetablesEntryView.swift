//
//  VegetablesEntryView.swift
//  WellPath
//
//  Entry form for logging vegetables intake
//

import SwiftUI

struct VegetablesEntryView: View {
    @Environment(\.dismiss) var dismiss
    @State private var selectedDateTime = Date()
    @State private var servingsAmount: String = ""
    @State private var selectedType: String = ""
    @State private var selectedTiming: String = ""
    @State private var vegetablesTypes: [ReferenceOption] = []
        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 12) {
                ZStack {
                    ...
                    Image(systemName: MetricsUIConfig.getIcon(for: "Vegetables"))
                        .font(.system(size: 32))
                ...
                if isLoading {
                    ...
                    Section {
                        Picker("Type", selection: $selectedType) {
                            ...
                            ForEach(vegetablesTypes, id: \.id) { option in
    ...
    private func loadReferenceData() async {
        ...
        do {
            // Load vegetables types from data_entry_fields_reference
            let typesResponse: [ReferenceOption] = try await supabase
                .from("data_entry_fields_reference")
                .select("id, display_name")
                .eq("reference_category", value: "vegetables_types")
            ...
            await MainActor.run {
                vegetablesTypes = typesResponse
                mealTimings = timingsResponse

                // Set default selections if available
                selectedType = vegetablesTypes.first?.id ?? ""
    ...
    private func saveVegetablesEntry() async {
        ...
        do {
            ...
            // Insert vegetables servings entry
            try await supabase
                .from("patient_data_entries")
                .insert([
                    "patient_id": userId,
                    "field_id": "DEF_VEGETABLES_SERVINGS",
            ...
            // Optional: Insert vegetables type
            if !selectedType.isEmpty {
                try await supabase
                    .from("patient_data_entries")
                    .insert([
                        "patient_id": userId,
                        "field_id": "DEF_VEGETABLES_TYPE",
                        "entry_date": dateString,
                        "entry_timestamp": timestampString,
            ...
            if !selectedTiming.isEmpty {
                try await supabase
                    ...
                    .insert([
                        "patient_id": userId,
                        "field_id": "DEF_VEGETABLES_TIMING",
                        "entry_date": dateString,
                        "entry_timestamp": timestampString,
