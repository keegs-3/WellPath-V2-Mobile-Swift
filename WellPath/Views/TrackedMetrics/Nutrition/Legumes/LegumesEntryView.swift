...
struct LegumesEntryView: View {
                ...
                if isLoading {
                    ...
                    Section {
                        Picker("Type", selection: $selectedType) {
                            ...
                            ForEach(legumesTypes, id: \.id) { option in
    ...
    private func loadReferenceData() async {
        ...
        do {
            // Load legumes types from data_entry_fields_reference
            ...
            await MainActor.run {
                ...
                selectedType = legumesTypes.first?.id ?? ""
    ...
    private func saveLegumesEntry() async {
        ...
        do {
            ...
            // Insert legumes servings entry
            try await supabase
                .from("patient_data_entries")
                .insert([
                    "patient_id": userId,
                    "field_id": "DEF_LEGUMES_SERVINGS",
            ...
            // Optional: Insert legumes type
            if !selectedType.isEmpty {
                try await supabase
                    .from("patient_data_entries")
                    .insert([
                        "patient_id": userId,
                        "field_id": "DEF_LEGUMES_TYPE",
                        "entry_date": dateString,
                        "entry_timestamp": timestampString,
