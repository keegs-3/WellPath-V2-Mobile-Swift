//
//  LegumesPrimary.swift
//  WellPath
//
//  Primary view for Legumes metric
//  Shows D/W/M/6M/Y bar chart from ParentMetricBarChart
//

import SwiftUI

struct LegumesPrimary: View {
    let pillar: String
    let color: Color
    ...
    private var chartView: some View {
        VStack(spacing: 24) {
            // Show the legumes servings chart
