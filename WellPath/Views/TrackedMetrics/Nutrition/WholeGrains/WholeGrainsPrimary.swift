//
//  WholeGrainsPrimary.swift
//  WellPath
//
//  Primary view for Whole Grains metric
//  Shows D/W/M/6M/Y bar chart from ParentMetricBarChart
//

import SwiftUI

struct WholeGrainsPrimary: View {
    let pillar: String
    let color: Color
    ...
    private var chartView: some View {
        VStack(spacing: 24) {
            // Show the whole grains servings chart
            if let metric = viewModel.metrics.first {
                ...
                Button(action: {
                    ...
                    Text("View More Whole Grains Data")
                        .font(.subheadline)
                        .fontWeight(.semibold)
