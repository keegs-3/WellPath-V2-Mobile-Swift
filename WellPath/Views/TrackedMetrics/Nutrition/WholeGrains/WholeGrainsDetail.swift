    ...
    var body: some View {
        VStack(spacing: 0) {
            if showAbout {
                ...
                NutrientTimingTimelineView(nutrientType: .wholeGrains, color: color, showAbout: $showAbout)
            }
        }
        .task {
    ...
    var body: some View {
        VStack(spacing: 0) {
            if showAbout {
                ...
                NutrientTypeView(nutrientType: .wholeGrains, color: color, showAbout: $showAbout)
            }
        }
        .task {
            await educationViewModel.loadEducation()
