...
//  WellPath
//
//  Entry form for logging blood pressure (systolic/diastolic) to patient_correlation_samples
//
...
struct BloodPressureEntryView: View {
    ...
    private func saveEntries() async {
        ...
        do {
            ...
            // Save as correlation sample (systolic and diastolic together in one row)
            let bpSample = CorrelationSampleWrite.bloodPressure(
                patientId: userId,
                systolic: systolic,
                diastolic: diastolic,
                pulse: nil,
                sampleTime: selectedDateTime,
