//
//  FatsAmountCard.swift
//  WellPath
//
//  Reusable card for Fat Amount metric.
//

import SwiftUI

struct FatsAmountCard: View {
    let color: Color
    let pillar: String
    ...
    var body: some View {
        MetricCardView(
            ...
            FatsAmountMiniCard(viewModel: viewModel, color: color)
        } fullScreen: {
...
struct FatsAmountMiniCard: View {
...
#Preview {
    FatsAmountCard(color: .orange, pillar: "Healthful Nutrition")
        .padding()
}
