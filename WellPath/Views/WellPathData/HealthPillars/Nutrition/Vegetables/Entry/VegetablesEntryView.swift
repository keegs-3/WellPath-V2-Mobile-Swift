...
struct VegetablesEntryView: View {
                ...
                if isLoading {
                    ...
                    Section {
                        Picker("Type", selection: $selectedType) {
                            ...
                            ForEach(vegetablesTypes, id: \.referenceKey) { option in
    ...
    private func loadReferenceData() async {
        ...
        do {
            // Load vegetables types from sample_category_types_reference (using reference_key for metadata)
            ...
            await MainActor.run {
                ...
                selectedType = vegetablesTypes.first?.referenceKey ?? ""
    ...
    private func saveVegetablesEntry() async {
        ...
        do {
            ...
            let sample = QuantitySampleWrite.create(
                patientId: userId,
                quantityType: QuantityTypes.vegetablesServings,
                value: amountValue,
                unit: "serving",
