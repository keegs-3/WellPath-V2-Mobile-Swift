...
struct WholeGrainsEntryView: View {
                ...
                if isLoading {
                    ...
                    Section {
                        Picker("Type", selection: $selectedType) {
                            ...
                            ForEach(wholeGrainsTypes, id: \.referenceKey) { option in
    ...
    private func loadReferenceData() async {
        ...
        do {
            // Load whole grains types from sample_category_types_reference (using reference_key for metadata)
            ...
            await MainActor.run {
                ...
                selectedType = wholeGrainsTypes.first?.referenceKey ?? ""
    ...
    private func saveWholeGrainsEntry() async {
        ...
        do {
            ...
            if !selectedType.isEmpty {
                metadata["whole_grains_type"] = .string(selectedType)
            }
            ...
            let sample = QuantitySampleWrite.create(
                patientId: userId,
                quantityType: QuantityTypes.wholeGrainsServings,
                value: amountValue,
                unit: "serving",
