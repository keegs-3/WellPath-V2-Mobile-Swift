//
//  NutsSeedsServingsCard.swift
//  WellPath
//
//  Reusable card for Nuts & Seeds Servings metric.
//

import SwiftUI

struct NutsSeedsServingsCard: View {
    let color: Color
    let pillar: String
    ...
    var body: some View {
        MetricCardView(
            ...
            NutsSeedsServingsMiniCard(viewModel: viewModel, color: color)
        } fullScreen: {
...
struct NutsSeedsServingsMiniCard: View {
...
#Preview {
    NutsSeedsServingsCard(color: .brown, pillar: "Healthful Nutrition")
        .padding()
}
