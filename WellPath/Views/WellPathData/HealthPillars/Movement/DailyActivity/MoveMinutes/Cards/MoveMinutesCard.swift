//
//  MoveMinutesCard.swift
//  WellPath
//
//  Card component for Move Minutes metric.
//

import SwiftUI

struct MoveMinutesCard: View {
    let color: Color
    let pillar: String
    let sectionId: String

    @StateObject private var viewModel = StandardMetricViewModel(metricId: "DISP_MOVE_MINUTES")
    ...
    var body: some View {
        MetricCardView(
            title: "Move Minutes",
            color: color,
            metricId: "SCREEN_MOVE_MINUTES",
            pillar: pillar,
            cardId: "CARD_MOVE_MINUTES",
            sectionId: sectionId,
            itemType: .screen
        ) {
            MoveMinutesMiniCardContent(viewModel: viewModel, color: color)
        } fullScreen: {
            MoveMinutesScreen(pillar: pillar, color: color, sectionId: sectionId)
        }
        .task {
...
struct MoveMinutesMiniCardContent: View {
...
#Preview {
    MoveMinutesCard(color: .orange, pillar: "Movement + Exercise")
        .padding()
}
