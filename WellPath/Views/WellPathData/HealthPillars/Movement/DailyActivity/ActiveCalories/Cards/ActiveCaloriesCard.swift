...
//  WellPath
//
//  Card component for Active Calories metric.
//
...
struct ActiveCaloriesCard: View {
    ...
    @StateObject private var viewModel = StandardMetricViewModel(metricId: "DISP_ACTIVE_CALORIES")
    ...
    var body: some View {
        MetricCardView(
            ...
            color: color,
            metricId: "SCREEN_ACTIVE_CALORIES",
            pillar: pillar,
            cardId: "CARD_ACTIVE_CALORIES",
            sectionId: sectionId,
            itemType: .screen
        ) {
            ActiveCaloriesMiniCardContent(viewModel: viewModel, color: color)
        } fullScreen: {
            ActiveCaloriesScreen(pillar: pillar, color: color, sectionId: sectionId)
        }
        .task {
...
struct ActiveCaloriesMiniCardContent: View {
...
#Preview {
    ActiveCaloriesCard(color: .orange, pillar: "Movement + Exercise")
        .padding()
}
