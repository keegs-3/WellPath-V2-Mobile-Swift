//
//  ExerciseSnacksCard.swift
//  WellPath
//
//  Card component for Exercise Snacks metric.
//

import SwiftUI

struct ExerciseSnacksCard: View {
    let color: Color
    let pillar: String
    let sectionId: String

    @StateObject private var viewModel = StandardMetricViewModel(metricId: "DISP_EXERCISE_SNACKS")
    ...
    var body: some View {
        MetricCardView(
            ...
            color: color,
            metricId: "SCREEN_EXERCISE_SNACKS",
            pillar: pillar,
            cardId: "CARD_EXERCISE_SNACKS",
            sectionId: sectionId,
            itemType: .screen
        ) {
            ExerciseSnacksMiniCardContent(viewModel: viewModel, color: color)
        } fullScreen: {
            ExerciseSnacksScreen(pillar: pillar, color: color, sectionId: sectionId)
        }
        .task {
...
struct ExerciseSnacksMiniCardContent: View {
...
#Preview {
    ExerciseSnacksCard(color: .orange, pillar: "Movement + Exercise")
        .padding()
}
