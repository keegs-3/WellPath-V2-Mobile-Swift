...
private extension StrengthTrainingEntryView {
    func loadReferenceData() async {
        ...
        do {
            // Load strength types from sample_category_types_reference
            ...
            // Load intensity levels from sample_category_types_reference
            ...
            // Load muscle groups from sample_category_types_reference
    ...
    func saveStrengthTrainingEntry() async {
        ...
        do {
            ...
            // Create single patient_quantity_samples entry with duration and metadata
