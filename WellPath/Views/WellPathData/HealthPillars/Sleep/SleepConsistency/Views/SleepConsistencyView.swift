...
//  WellPath
//
//  Main view for Sleep Consistency metric (DISP_SLEEP_CONSISTENCY).
//  Shows bedtime/waketime consistency across W/M/6M/Y periods.
//
...
struct SleepConsistencyView: View {
    ...
    @StateObject private var primaryViewModel = SleepAnalysisPrimaryViewModel(viewId: "DISP_SLEEP_CONSISTENCY")
    ...
    private let metricId = "DISP_SLEEP_CONSISTENCY"
    private let metricName = "Sleep Consistency"
        ...
        chartContent
            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .navigationBarTrailing) {
                    FavoriteButton(
                        itemType: .screen,
                        itemId: "SCREEN_SLEEP_CONSISTENCY",
