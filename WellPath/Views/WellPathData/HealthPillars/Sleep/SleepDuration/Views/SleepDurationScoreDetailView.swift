//
//  SleepDurationScoreDetailView.swift
//  WellPath
//
//  Detail view showing sleep duration score with Today/History/Baseline tabs.
//

import SwiftUI

struct SleepDurationScoreDetailView: View {
    @ObservedObject var viewModel: SleepDurationScoreViewModel
    let color: Color
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Sleep Duration Score")
    ...
    private var baselineTabContent: some View {
        VStack(spacing: 20) {
            ...
            // Show baseline value
            if let sleepHours = viewModel.baselines["daily_sleep_hours"] {
                baselineSummaryCard(sleepHours: sleepHours)
            }
    ...
    private func baselineSummaryCard(sleepHours: Double) -> some View {
    ...
    private func loadScoreHistory() async {
        ...
        do {
            ...
            let results: [ScoreSample] = try await client
                ...
                .eq("quantity_type", value: "sleep_duration_score")
...
#Preview {
    SleepDurationScoreDetailView(
        viewModel: SleepDurationScoreViewModel(),
        color: .teal
    )
}
