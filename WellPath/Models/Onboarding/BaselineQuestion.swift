...
//  WellPath
//
//  Model for baseline questions - simplified survey system
//  that links directly to baseline types and tracked quantity types.
//
...
/// Response to a baseline question - stored in patient_baseline_samples
struct BaselineQuestionResponse {
    let questionId: String
    let baselineType: String
    var value: Double?
